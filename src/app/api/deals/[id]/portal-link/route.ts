              ...
              <table cellpadding="0" cellspacing="0" style="margin:0 auto;">
                <tr>
                  ...
                  <td style="padding-left:10px;vertical-align:middle;">
                    <span style="color:#f0f5f2;font-size:18px;font-weight:700;letter-spacing:-0.02em;">LendFlow</span>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td style="background:#f0f0f0;border-radius:0 0 12px 12px;padding:20px 36px;text-align:center;">
              <p style="margin:0;font-size:12px;color:#999;">
                Sent by <strong>${bankName}</strong> via LendFlow · This is a secure, time-limited link
              </p>
            </td>
          </tr>
